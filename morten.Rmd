...
#mumin
MuMIn::r.squaredGLMM(null, m1, m2)
...
sum_m3 <- summary(m3)
residuals <- sum_m3$residuals

#making a df with actual values and predicted values
exciting <- data.frame("actual" = df$CHI_MLU, "residuals" = sum_m3$residuals, "predicted" =df$CHI_MLU + sum_m3$residuals)
